...
void DS3231_set_init_conf() {
	unsigned char rtc_conf = 0x04;	// Default enable the interrupt pin, but disable Alarm interrupt output
									// Alarm interrupt output will be enabled / disabled manually in configure mode
